class cfgPatches
{
    class SiP_Patch_enfield_rifle
    {
        ...
        weapons[] = 
        {
            ...
            "SiP_lee_enfield_no4_mkI_sniper",
...
class cfgWeapons
{
    ...
    class SiP_lee_enfield_no4_mki: vn_rifle_boltaction_base
    {
        ...
        class Single: Mode_SemiAuto
        {
            ...
            {
                soundSetShot[] = {"jsrs_leeenfield_shot_soundset","vn_bolt_rifle_tails_soundset","vn_boltaction_trigger_reset_soundset"};
            };
            reloadTime = 1;
            dispersion = 0.00035;
    ...
    class SiP_lee_enfield_no4_mkI_sniper: SiP_lee_enfield_no4_mki
    {
    ...
    class SiP_lee_enfield_no4_mkI_sniper_scope: SiP_lee_enfield_no4_mkI_sniper
    {
        class LinkedItems
        {
