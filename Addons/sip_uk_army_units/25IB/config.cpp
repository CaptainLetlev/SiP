...
class CfgVehicles
{
    ...
    class SiP_BCFK_25cib_piat: SiP_BCFK_25cib_rifleman1
    {
        ...
        weapons[] = {"SiP_sten_mkii","LIB_PIAT","Throw","Put"};
        ...
        respawnWeapons[] = {"SiP_sten_mkii","LIB_PIAT","Throw","Put"};
    ...
    class SiP_BCFK_25cib_m20_bazooka: SiP_BCFK_25cib_piat
    {
        ...
        linkedItems[] = {"H_LIB_UK_Beret","SiP_P37_uk_vest","Big_Three_uk_fieldgear_od","vn_b_item_map","vn_b_item_compass","vn_b_item_watch"};
        respawnLinkedItems[] = {"H_LIB_UK_Beret","SiP_P37_uk_vest","Big_Three_uk_fieldgear_od","vn_b_item_map","vn_b_item_compass","vn_b_item_watch"};
        weapons[] = {"SiP_sten_mkii","SiP_m20_super_bazooka","Throw","Put"};
        respawnWeapons[] = {"SiP_sten_mkii","SiP_m20_super_bazooka","Throw","Put"};
        magazines[] = {"vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","SiP_M28A2_heat_rocket"};
        respawnMagazines[] = {"vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","vn_sten_mag","SiP_M28A2_heat_rocket"};
