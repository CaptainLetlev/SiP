...
class SiP_Radios_prc6_radio_dialogue
{
    ...
    onLoad = "if (sunOrMoon < 0.2) then {((_this select 0) displayCtrl 67676) ctrlSetText '\WW2_Radios\addons\WW2_Radios\Short-Range\BC_611\Allied\data\BC611_radio_notes.paa';};";
