class cfgPatches
{
    class SiP_Patch_t34_85
    {
        ...
        requiredAddons[] = 
        {
            ...
            "WW2_Assets_c_Vehicles_Tanks_c_T34_85",
...
class cfgVehicles
{
    ...
    class SiP_t34_85_base: LIB_T34_85_base
    {   
        author = "Letlev";
        side = 0;
        scope = 1;
        ...
        soundEngineOffExt[] = {"\WW2\Assets_s\Vehicles\Tanks_s\T34_76\T34_76_Ext_Engine_Stop.wss",3.1622,1,200};
        soundEngineOffInt[] = {"\WW2\Assets_s\Vehicles\Tanks_s\T34_76\T34_76_Int_Engine_Stop.wss",3.1622,1};
        soundEngineOnExt[] = {"\WW2\Assets_s\Vehicles\Tanks_s\T34_76\T34_76_Ext_Engine_Start.wss",3.1622,1,200};
        soundEngineOnInt[] = {"\WW2\Assets_s\Vehicles\Tanks_s\T34_76\T34_76_Int_Engine_Start.wss",3.1622,1};
        ...
        class Sounds
        {
            soundSetsExt[] = {"vn_t54_engine_idle_ext_soundset","vn_t54_engine_high_ext_soundset","vn_t54_engine_high_exh_soundset","vn_t54_rattle_ext_soundset","vn_t54_engine_rev_ext_soundset","vn_t54_engine_distance_soundset","vn_t54_start_exterior_soundset","vn_tank_treads_pavn_distance_soundset","vn_t54_track_left_slow_soundset","vn_t54_track_left_fast_soundset","vn_t54_track_right_slow_soundset","vn_t54_track_right_fast_soundset"};
            soundSetsInt[] = {"vn_t54_engine_idle_int_soundset","vn_t54_engine_high_int_soundset","vn_t54_engine_high_int_res_soundset","vn_t54_rattle_int_soundset","vn_t54_rattle_drive_soundset","vn_t54_start_interior_soundset","vn_t54_int_track_left_slow_soundset","vn_t54_int_track_left_fast_soundset","vn_t54_int_track_right_slow_soundset","vn_t54_int_track_right_fast_soundset","vn_truck_rainint_soundset","tanks_material_strain_int_soundset"};
        };
        class HitPoints: HitPoints
        {
        ...
        LIB_CrewPoints[] = {};
        LIB_Cargo_Dir[] = {};
        LIB_Layers_Array[] = {"SiP_T3485_Optic","Load_Bar","Background","Fuel_Arrow","Speed_Arrow","Cover","Vehicle","Commander_View","Glass"};
        class Layers
        {
            class SiP_T3485_Optic
            {
                LIB_Layers_Array[] = {"Static_Line","Sight_Grid","Sight_Triangles"};
                class Layers
                {
                    class Static_Line
                    {
                        Type[] = {1,0,1,0};
                        Text = "\WW2\Core_t\IF_Core_t\Generic\textureline3d_ca.paa";
                        Color[] = {{"color",{{0,0,0,0.85},{0,0,0,0}},"tank_sight_visible"},"LIB_Get_Control_Parameter"};
                        Angle = 0;
                        x = "0.0776045 * safeZoneWAbs + safeZoneXAbs";
                        y = "0.317594 * safezoneH + safezoneY";
                        w = "0.782917 * safeZoneWAbs";
                        h = "0.00870376 * safezoneH";
                    };
                    class Sight_Grid: Static_Line
                    {
                        Type[] = {1,1,1,0};
                        Text = "\WW2\Assets_t\Vehicles\Optics_t\IF_T3485_Reticle_ca.paa";
                        x = "0.278646 * safeZoneWAbs + safeZoneXAbs";
                        y[] = {{"position",{"-0.282407 * safezoneH + safezoneY","safeZoneH/2.75"},"tank_sight_distance"},"LIB_Get_Control_Parameter"};
                        w = "0.448021 * safeZoneWAbs";
                        h = "0.718888 * safezoneH";
                    };
            ...
            {
                Type[] = {1,0,0,0};
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Tanks\Base.paa";
                Color[] = {1,1,1,1};
                Angle = 0;
                x = "(((safeZoneXAbs max safeZoneX) - (0.001 * 2)) + ((safeZoneWAbs min (safeZoneW*(1.25))) - ((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))))";
                y = "(safeZoneY + 0.001)";
                w = "((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))";
                h = "((safeZoneH*0.43)*(getResolution select 5))";
            };
            class Cover: Background
            {
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Tanks\Cover.paa";
            };
            class Glass: Background
            {
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Tanks\Glass.paa";
            };
            class Fuel_Arrow: Background
            {
                Type[] = {1,0,0,1};
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Vehicles\Fuel_Arrow.paa";
                Angle[] = {{"angle",{-73,61.7},"fuel"},"LIB_Get_Control_Parameter"};
            };
            class Speed_Arrow: Fuel_Arrow
            {
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Vehicles\Speed_Arrow.paa";
                Angle[] = {{"angle",{11.3,62},"speed"},"LIB_Get_Control_Parameter"};
            };
            class Commander_View: Fuel_Arrow
            {
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Tanks\Comm_View.paa";
                Color[] = {1,1,1,1};
                Angle[] = {{"angle","commander_view_direction"},"LIB_Get_Control_Parameter"};
            };
            class Load_Bar: Fuel_Arrow
            {
                Text = "\WW2\Core_f\IF_System_Tank_Interface_t\UI\Tanks\Load_Bar.paa";
                Angle[] = {{"angle",{-71.5,143},"reload"},"LIB_Get_Control_Parameter"};
                x = "(((safeZoneXAbs max safeZoneX) - (0.001 * 2)) + ((safeZoneWAbs min (safeZoneW*(1.25))) - (((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))*1.015)))";
                y = "((safeZoneY + 0.001) - (((safeZoneH*0.43)*(getResolution select 5))*0.015))";
                w = "(((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))*1.03)";
                h = "(((safeZoneH*0.43)*(getResolution select 5))*1.03)";
            };
            class Vehicle
            {
                LIB_Layers_Array[] = {"ltrack","rtrack","hull","engine","turret","gun"};
                class Layers
                {
                    class ltrack: Background
                    {
                        Type[] = {1,0,1,1};
                        x = "(((safeZoneXAbs max safeZoneX) - (0.001 * 2)) + ((safeZoneWAbs min (safeZoneW*(1.25))) - (((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))*0.9)))";
                        y = "(safeZoneY + ((safeZoneH*0.43)*(getResolution select 5))*0.1 + 0.001)";
                        w = "(((safeZoneWAbs*0.43)/(getResolution select 4)*(getResolution select 5))*0.8)";
                        h = "(((safeZoneH*0.43)*(getResolution select 5))*0.8)";
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Ltrack.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"ltrack"},"LIB_Get_Control_Parameter"};
                        Angle[] = {{"angle","hull"},"LIB_Get_Control_Parameter"};
                    };
                    class rtrack: ltrack
                    {
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Rtrack.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"rtrack"},"LIB_Get_Control_Parameter"};
                    };
                    class hull: ltrack
                    {
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Hull.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"hull"},"LIB_Get_Control_Parameter"};
                    };
                    class engine: ltrack
                    {
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Engine.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"engine"},"LIB_Get_Control_Parameter"};
                    };
                    class turret: ltrack
                    {
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Turret.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"turret"},"LIB_Get_Control_Parameter"};
                        Angle[] = {{"angle","turret"},"LIB_Get_Control_Parameter"};
                    };
                    class gun: turret
                    {
                        Text = "\WW2\Core_t\IF_Data_t\Extended_HUD\Tanks\T34_85\Gun.paa";
                        Color[] = {{"color",{{0.91,0.89,0.66,1},{0.706,0.0745,0.0196,1},{0.2,0.2,0.2,1}},"gun"},"LIB_Get_Control_Parameter"};
                    };
                };
            };
        };
