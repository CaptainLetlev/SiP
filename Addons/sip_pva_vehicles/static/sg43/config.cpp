...
{
	class SiP_SG43_close_distance_shot_soundshader
	{
	...
	class SiP_SG43_closeShot_SoundShader
	{
		samples[] = {{"fow\fow_sounds\weapons\type99\type99_action",1}};
		volume = 1;
		range = 50;
...
class cfgsoundsets
{
	class vn_sgmt_shot_soundset;

	class SiP_sg43_shot_soundset: vn_sgmt_shot_soundset
	{
		soundshaders[] = 
		{
			"SiP_SG43_closeShot_SoundShader",
			"SiP_SG43_close_distance_shot_soundshader",
			"vn_sgmt_medium_distance_shot_soundshader",
			"vn_sgmt_far_distance_shot_soundshader"
		};
	};
};
