...
class cfgVehicles
{
    ...
    class SPE_US_M3_Halftrack: SPE_M3A1_Halftrack_base
    {
    ...
    class SPE_US_M16_Halftrack: SPE_US_M16_Halftrack_base
	{
        class Turrets: Turrets
        {
            class MainTurret;
    ...
    class SiP_M3A1_Halftrack: SPE_US_M3_Halftrack
    {
        author = "Letlev";
    ...
    class SiP_M16_Halftrack: SPE_US_M16_Halftrack
    {
        author = "Letlev";
